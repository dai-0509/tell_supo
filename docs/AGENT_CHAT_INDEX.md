...
|---------|------|--------|------|---------------|-------------|
| feat/f007-crud-01-spec | 仕様/受入基準ドキュメント作成 | ⏸️ 未開始 | - | - | 顧客CRUD仕様書作成依頼 |
| feat/f007-crud-02-db-constraints | customers に UNIQUE/INDEX/FK 追加 | ⏸️ 未開始 | - | - | 01-spec完了後に開始 |
| feat/f007-crud-03-formrequest | Store/Update FormRequest と電話正規化 | ⏸️ 未開始 | - | - | 02-db完了後に開始 |
| feat/f007-crud-04-controller | create/store/edit/update の最小実装 | ⏸️ 未開始 | - | - | 03-formrequest完了後に開始 |
| feat/f007-crud-05-ui | 登録/編集フォーム（必須・エラー表示・戻る導線） | ⏸️ 未開始 | - | - | 04-controller完了後に開始 |
| feat/f007-crud-06-tests | 正常/重複/未入力の Feature テスト | ⏸️ 未開始 | - | - | 05-ui完了後に開始 |

### F005 顧客一覧

| ブランチ | 目的 | Status | Chat | Last Decision | Next Prompt |
|---------|------|--------|------|---------------|-------------|
| feat/f005-index-01-spec | 仕様/受入基準ドキュメント作成 | ⏸️ 未開始 | - | - | F007完了後に開始 |
...
| feat/f005-index-06-tests | 一覧/検索/ページング/空状態のテスト | ⏸️ 未開始 | - | - | 05-search-sort完了後に開始 |

### F012 架電記録（追加/編集）

| ブランチ | 目的 | Status | Chat | Last Decision | Next Prompt |
|---------|------|--------|------|---------------|-------------|
| feat/f012-calllog-01-spec | 仕様/受入基準ドキュメント作成 | ⏸️ 未開始 | - | - | F005完了後に開始 |
...
| ブランチ | 目的 | Status | Chat | Last Decision | Next Prompt |
|---------|------|--------|------|---------------|-------------|
| feat/f001-weekly-01-spec | 週範囲/JST/算式などの仕様確定 | ⏸️ 未開始 | - | - | F012完了後に開始 |
